const app = new Vue({
    ...
    data: {
        title: "Portfolio",
        goal: "My goal is to take on an important role in the development of emerging and unique games and digital media. I focus on tools design, graphics programming, and optimizations, but also make sure to have a good grasp on a wide variety of programming and design concepts. I find myself feeling truly passionate about the work I’ve done when I can see what I’m working on run a little faster, make someone's life a bit easier, or have something look better than it did the day before. I hope to continue to hone these skills and create truly next-level work. Check out some of my work below!",
        selectedProject: {},
        projects: [{
            name: "Dungeon Display",
            image: "../portfolioMedia/media/icons/DD_LibLogo.png",
            ...
            <div class="row">
                <aside class="col-lg" id="intro">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/ShadowGenExample.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/DDExampleB.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/DDExampleA.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                    </div>
                    <br>
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/DDExampleC.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                        <aside class="col-md" id="recentText">
            ...
            image: "../portfolioMedia/media/icons/CSP_Icon.png",
            ...
            <div class="row">
                <aside class="col-lg" id="intro">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/particlesDisplay.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                        <aside class="col-md" id="recentText">
...
<br>
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/particlesSample.png" class="currentImageItem" alt="ShadowGen">
                        </aside>
                    </div>
                    <br>
                    <div class="row">
            ...
            image: "../portfolioMedia/media/icons/EE_Icon.png",
            ...
            <div class="row">
                <aside class="col-lg" id="intro">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/extensiveCode.png" class="currentImageItem" alt="ShadowGen">
                        </aside>
                        <aside class="col-md" id="recentText">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/extensiveSample.png" class="currentImageItem" alt="ShadowGen">
                        </aside>
                    </div>
                    <br>
                    <div class="row">
            ...
            image: "../portfolioMedia/media/icons/ftaSample.png",
            ...
            <div class="row">
                <aside class="col-lg" id="intro">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/fftDisplayA.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                        <aside class="col-md" id="recentText">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/fftDisplayB.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                        <aside class="col-md">
                        </aside>
                    </div>
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/fftCode.png" class="currentImageItem" alt="ShadowGen">
                        </aside>
                    </div>
                    <br>
                    <div class="row">
            ...
            image: "../portfolioMedia/media/icons/AV_Icon.png",
            ...
            <div class="row">
                <aside class="col-lg" id="intro">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/avDisplay.gif" class="currentImageItem" alt="ShadowGen">
                        </aside>
                        <aside class="col-md" id="recentText">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/avSample.png" class="currentImageItem" alt="ShadowGen">
                        </aside>
                    </div>
                    <br>
                    <div class="row">
            ...
            name: "Faux-llotaxis",
            image: "../portfolioMedia/media/icons/FT_Icon.png",
            ...
            <div class="row">
                <aside class="col-lg" id="intro">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/ftSample.png" class="currentImageItem" alt="Faux-llotaxis">
                        </aside>
                        <aside class="col-md" id="recentText">
                    ...
                    <div class="row">
                        <aside class="col-md">
                            <img src="../portfolioMedia/media/ftCode.png" class="currentImageItem" alt="ftCode">
                        </aside>
                    </div>
                    <br>
                    <div class="row">
